...
export function ChatComponent({
  ...
  const [selectedModel, setSelectedModel] = useState<typeof MODEL_OPTIONS[number]>(
    "claude-3-haiku"
  );
  ...
  console.log({selectedModel,provider})
...
useEffect(() => {
  ...
  return (
    <div className="flex flex-col justify-between w-[100%] h-[100%]  max-h-[70vh] border-2 border-gray-200 shadow rounded-lg bg-gray-100">
    ...
    <footer className="p-2 flex">
      ...
      />
      <Button
        onClick={(e) => handleSubmit(inputMessage)}
        disabled={isLoading}
